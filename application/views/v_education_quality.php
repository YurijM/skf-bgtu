	...
	<ul style="list-style-type: disc">
		...
		<li>
			<?= HTML::anchor(
				...
				'направление 08.03.01 «Строительство» профиль «Промышленное и гражданское строительство»',
				['target' => '_blank']
			) ?>
		</li>
		<li>
			<?= HTML::anchor(
				...
				'направление 08.03.01 «Строительство» профиль «Теплогазоснабжение и вентиляция»',
				['target' => '_blank']
			) ?>
		</li>
		<li>
