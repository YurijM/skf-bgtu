<div class="objects row">
	...
	<h4 class="text-center">
		Информация о наличии средств обучения и воспитания
	</h4>
	...
	<p>
		В университете создан студенческий совет. Студенческий совет - это центр культурно-массовой и воспитательной
		работы со студенческой молодежью. Культурно-массовая работа помогает молодым людям адаптироваться в современном
		обществе, реализовать свои таланты и возможности, сформировать у молодежи активную жизненную позицию и
		готовность к участию в общественно-политической жизни страны и гражданского общества.
	</p>
	<p>
		Для студентов ежегодно проводятся культурно-воспитательные мероприятия, такие как: лектории; конкурсы;
		спортивные состязания; встречи с интересными людьми, ветеранами и участниками боевых действий, представителями
		профильных
		служб: миграционной службы, полиции, УФСКН, медицины, духовенства и др. Студенты выезжают на экскурсии.
	</p>
	<p>
		В университете успешно функционирует кураторство. Куратор каждой группы — опытный преподаватель, имеющий стаж
		...
		причиняющей вред их здоровью и развитию, побуждающей к самоубийству; студенты совместно с кураторами принимают
		участие не
		только в мероприятиях, реализующихся на базе университета, но и в городских и областных мероприятиях, также
		посещают выставки, театры, кинотеатры и др.
	</p>
	<p>
		Университет уделяет пристальное внимание развитию студенческого спорта. В филиале имеется
		физкультурно-оздоровительный центр, где имеются все возможности для проведения спортивной работы. В здании ФОЦ
		есть спортивный зал площадью 540 кв.м., тренажерные залы, залы для фитнеса. Согласно календарного плана
		спортивно-массовых мероприятий студенты участвуют в внутривузовских, городских, региональных соревнованиях.
	</p>


	<h4 class="text-center">
		Сведения о наличии у СКФ БГТУ им.В.Г.Шухова на праве оперативного управления зданий, строений, сооружений,
	...
	<h4 class="text-center">
		Сведения о доступе к электронно-информационной образовательной среде, информационным системам и
	...
	<div class="table-responsive">
		<table class="table table-bordered table-condensed bg-success" itemprop="erList">
			...
			<tr>
				...
				<td class="text-center">библиотека</td>
			</tr>
			<tr>
