<div class="matriculants">
            ...
            <table class="table table-bordered table-condensed bg-info">
              ...
              <? foreach ($costs_kind['budget'] as $matriculant): ?>
                <tr>
                  ...
                  <? $points = $matriculant->points_1 + $matriculant->points_2 + $matriculant->points_3 ?>
                  ...
                  <td class="text-center">
                    <?=$matriculant->points_1 + $matriculant->points_2 + $matriculant->points_3 + $matriculant->test + $matriculant->achievement?>
                  </td>
  ...
  <? if ($count_intramural + $count_extramural == 0): ?>
