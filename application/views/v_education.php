...
<div class="education row">
	...
	<h5 class="text-center">
		Информация о реализуемых образовательных программах с указанием уровня общего или профессионального
		образования, формы обучения, нормативного срока
		обучения, кода и наименования профессии, специальности, направления подготовки, учебных предметов,
		дисциплин (модулей), практики<br>
		Информация о наличии или об отсутствии государственной аккредитации образовательной деятельности по
		...
		<table class="table-responsive table-condensed table-bordered" itemprop="eduAccred">
			<tr>
				...
				<th rowspan="2" style="width: 10%">
					Учебные предметы, дисциплины (модули), практики, предусмотренные соответствующей образовательной
					программой
				</th>
				<th rowspan="2" style="width: 10%">
					Наличие или отсутствие государственной аккредитации (ГА) образовательной деятельности. Срок действия
					ГА
				</th>
			</tr>
			<tr>
...
Уникальный ключ: 5f9e5d79cd1555bedbf271ba7dddc82b7348723b'
				...
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . 'kg_07.02.01_22-23.pdf',
						HTML::image(
							$dir_img . 'signature.png',
							[
								'style' => 'max-width: 1.5em; margin-right: .5em',
...
Уникальный ключ: 5f9e5d79cd1555bedbf271ba7dddc82b7348723b'
				...
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . 'kg_08.02.01_23.pdf',
						HTML::image(
							$dir_img . 'signature.png',
							[
								'style' => 'max-width: 1.5em; margin-right: .5em',
...
Уникальный ключ: 5f9e5d79cd1555bedbf271ba7dddc82b7348723b'
			...
			<tr>
				...
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . 'up_09.02.12.pdf',
						HTML::image(
							$dir_img . 'signature.png',
							[
								'style' => 'max-width: 1.5em; margin-right: .5em',
								'title' => 'Файл подписан простой электронной подписью
Дата, время: 20.01.2025 11:12
ФИО: Курбатов Владимир Леонидович
Должность: первый заместитель директора
Уникальный ключ: 5f9e5d79cd1555bedbf271ba7dddc82b7348723b'
							]
				...
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . 'hop_09.02.12.pdf',
						HTML::image(
							$dir_img . 'signature.png',
							[
								'style' => 'max-width: 1.5em; margin-right: .5em',
...
Уникальный ключ: 5f9e5d79cd1555bedbf271ba7dddc82b7348723b'
				...
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . 'pp_09.02.12.pdf',
						HTML::image(
							$dir_img . 'signature.png',
							[
								'style' => 'max-width: 1.5em; margin-right: .5em',
								'title' => 'Файл подписан простой электронной подписью
Дата, время: 15.05.2025
ФИО: Курбатов Владимир Леонидович
Должность: первый заместитель директора
Уникальный ключ: 5f9e5d79cd1555bedbf271ba7dddc82b7348723b'
							]
				...
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . 'gia_09.02.12.pdf',
						HTML::image(
							$dir_img . 'signature.png',
							[
								'style' => 'max-width: 1.5em; margin-right: .5em',
...
Уникальный ключ: 5f9e5d79cd1555bedbf271ba7dddc82b7348723b'
	...
	<div class="table table-responsive">
		<table class="td-top table-responsive table-condensed table-bordered">
			<tr>
				...
				<th>Наименование профессии, специальности, направления подготовки</th>
				<th>
					Перечень научных направлений, в рамках которых ведется научная (научно-исследовательская)
					деятельность
				</th>
				<th>
					Сведения о научно-исследовательской базе для осуществления научной (научно-исследовательской)
					деятельности
				</th>
				<th>
			...
			<tr>
				...
				<td rowspan="3">
					...
					научного цитирования (РИНЦ) за последний год: 69
					шт.
				</td>
			</tr>
			<tr>
	...
	<div style="margin-bottom: 1em">
		Специальные технические средства обучения коллективного и индивидуального пользования для инвалидов и лиц
		с ограниченными возможностями здоровья на
		данный момент не имеются.
	</div>

	<h5 class="text-center">
		Информация о трудоустройстве выпускников в виде численности трудоустроенных выпускников прошлого учебного
		года, освоивших основные профессиональные
	...
	<div class="table table-responsive">
		<table class="table-responsive table-bordered table-condensed" itemprop="graduateJob">
			<tr>
				...
				<th>
					Наименование профессии, специальности, направления подготовки, наименование группы научных
					специальностей
				</th>
				<th>
