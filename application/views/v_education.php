	...
	<div class="table table-responsive">
		<table class="td-top table-responsive table-condensed table-bordered">
			...
			<tr>
				...
				<td>
					Разработка программного обеспечения интеллектуальных систем в технике, технологиях и
					информационной безопасности
				</td>
				<td>
					Библиотечно-информационный центр (библиотека).<br>
					Аудитории коллективного пользования информационного и коммуникационного оборудования
...
Уникальный ключ: 5f9e5d79cd1555bedbf271ba7dddc82b7348723b'
			...
			<?= Html::anchor(
				$dir_docs . 'rp_vosp.pdf',
				'Рабочая программа воспитания СПО и ВО',
				['target' => '_blank']
			) ?>;
		</li>
		<li>
			<?= Html::anchor(
				$dir_docs . 'kp_vosp.pdf',
				'Календарный план воспитательной работы СКФ БГТУ им.В.Г.Шухова на 2023-2024 год',
				['target' => '_blank']
			) ?>;
		</li>
		<li>
...
Уникальный ключ: 5f9e5d79cd1555bedbf271ba7dddc82b7348723b'
			...
			<?= Html::anchor(
				$dir_docs . 'kodeks_ch.pdf',
				'Кодекс чести коллектива федерального государственного бюджетного образовательного учреждения высшего образования «Белгородский государственный технологический университет им.В.Г.Шухова»',
				['target' => '_blank']
			) ?>;
		</li>
		<li>
...
Уникальный ключ: 5f9e5d79cd1555bedbf271ba7dddc82b7348723b'
			...
			<?= Html::anchor(
				$dir_docs . 'pol_starosta.pdf',
				'Положение о старосте учебной группы в БГТУ им.В.Г.Шухова',
				['target' => '_blank']
			) ?>;
		</li>
	</ul>
