...
Уникальный ключ: 5f9e5d79cd1555bedbf271ba7dddc82b7348723b'
	...
	<h5 class="text-center">
		Информация по лицензируемым образовательным программам
	</h5>
	...
	<div class="table table-responsive">
		<table class="table-responsive table-condensed table-bordered">
			...
			<tr>
				...
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . '3. Календарный учебный график 46.01.03.pdf.sig',
				...
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . '7. Договор о практической подготовке 46.01.03.pdf.sig',
						'<i class="far fa-file-pdf"></i> sig',
						['class' => 'btn btn-sm btn-success', 'target' => '_blank']
					) ?>
				</td>
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . '8. Рабочая программа воспитания 46.01.03.pdf.sig',
						'<i class="far fa-file-pdf"></i> sig',
						['class' => 'btn btn-sm btn-success', 'target' => '_blank']
					) ?>
				</td>
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . '9. Календарный план воспитательной работы 46.01.03.pdf.sig',
						'<i class="far fa-file-pdf"></i> sig',
						['class' => 'btn btn-sm btn-success', 'target' => '_blank']
					) ?>
				</td>
			...
			<tr>
				...
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . '1. ОПОП 08.02.01.pdf.sig',
						'<i class="far fa-file-pdf"></i> sig',
						['class' => 'btn btn-sm btn-success', 'target' => '_blank']
					) ?>
				</td>
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . '2. Учебный план 08.02.01.pdf.sig',
						'<i class="far fa-file-pdf"></i> sig',
						['class' => 'btn btn-sm btn-success', 'target' => '_blank']
					) ?>
				</td>
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . '3. Календарный учебный график 08.02.01.pdf.sig',
						'<i class="far fa-file-pdf"></i> sig',
						['class' => 'btn btn-sm btn-success', 'target' => '_blank']
					) ?>
				</td>
				...
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . '7. Договор о практической подготовке 08.02.01.pdf.sig',
						'<i class="far fa-file-pdf"></i> sig',
						['class' => 'btn btn-sm btn-success', 'target' => '_blank']
					) ?>
				</td>
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . '8. Рабочая программа воспитания 08.02.01.pdf.sig',
						'<i class="far fa-file-pdf"></i> sig',
						['class' => 'btn btn-sm btn-success', 'target' => '_blank']
					) ?>
				</td>
				<td class="text-center">
					<?= Html::anchor(
						$dir_docs_education . '9. Календарный план воспитательной работы 08.02.01.pdf.sig',
						'<i class="far fa-file-pdf"></i> sig',
						['class' => 'btn btn-sm btn-success', 'target' => '_blank']
					) ?>
				</td>
