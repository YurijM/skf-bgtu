...
Уникальный ключ: 5f9e5d79cd1555bedbf271ba7dddc82b7348723b'
				...
				) . 'Приказ об утверждении перечня предметов, веществ и устройств запрещенных к проносу (ввозу) на территорию СКФ БГТУ им.В.Г.Шухова',
				['target' => '_blank'],
