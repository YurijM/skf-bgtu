...
<div class="admin-list">
  <div class="text-right">
    <?=HTML::anchor('admin/safetyhealth', 'К списку курсов по ОТ и ТБ')?>
  </div>

  <?=Form::open('admin/safetyhealth/save')?>
    ...
    <div class="form-group">
      ...
      <?=Form::textarea('listener_category', $course->listener_category, array('class' => 'form-control', 'rows' => 3, 'placeholder' => 'Поле listener_category'))?>
    </div>
