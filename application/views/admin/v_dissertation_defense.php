    ...
    <div class="form-group">
      ...
      <select name="personnel" class="form-control" autofocus>
        ...
        <? foreach ($personnel as $employee): ?>
          <option <?=($dissertationdefense->personnel_id == $employee->id ? 'selected' : '')?> value="<?=$employee->id?>"><?=$employee->family.' '.$employee->name.' '.$employee->patronymic?></option>
        <? endforeach ?>
      </select>
    </div>
    ...
    <div class="form-group">
      ...
      <select name="degree" class="form-control">
        ...
        <? foreach ($degrees as $degree): ?>
          <option <?=($dissertationdefense->degree_id == $degree->id ? 'selected' : '')?> value="<?=$degree->id?>"><?=$degree->degree?></option>
        <? endforeach ?>
      </select>
    </div>
