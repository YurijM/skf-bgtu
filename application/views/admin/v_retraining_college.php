...
<div class="admin-list">
  <div class="text-right">
    <?=HTML::anchor('admin/retrainingcollege', 'К списку курсов переподготовки для колледжей')?>
  </div>

  <?=Form::open('admin/retrainingcollege/save')?>
    <div class="form-group">
      <?=Form::label('course', 'Курс переподготовки')?>
    ...
    <div class="form-group">
      ...
      <?=Form::textarea('requirement', $retraining->requirement, array('class' => 'form-control', 'rows' => 10, 'placeholder' => 'Поле requirement'))?>
    </div>
...
<script>
  $(document).ready(function() {
    ...
    new AjaxUpload(btnUploadDoc, {
			action: '/admin/retrainingcollege/uploaddoc/',
			name: 'uploadfile',
