<div class="objects row" itemprop="mtoOvz">
	...
	<p>
		К средствам обучения относятся предметы материальной и духовной культуры, которые используются при решении педагогических задач. Они обеспечивают
		реализацию принципа наглядности и содействуют повышению эффективности учебного процесса, дают учащимся материал в форме наблюдений и впечатлений
		для осуществления учебного познания и мыслительной деятельности на всех этапах обучения.
	</p>
	<p>
		Электронная информационно-образовательная среда университета предоставляет возможность осуществлять дистанционное обучение. Обучающиеся имеют
		возможность самостоятельно изучать размещенные на сайте университета, а так же на сайте научно-технической библиотеки курсы учебных дисциплин. С
		помощью «Личного кабинета» студент с ограниченными возможностями здоровья может связаться с преподавателем для индивидуальной консультации по
		изучаемому материалу.
	</p>
	<p>
		Как для всех студентов филиала, так и для учащихся с общими заболеваниями, ежегодно проводятся культурно-воспитательные мероприятия, такие как:
		лектории; конкурсы; спортивные состязания; встречи с интересными людьми, ветеранами и участниками боевых действий, представителями профильных
	...
	<div itemprop="techOvz">
		...
		<p>
			Для слабовидящих обучающихся (при их наличии) в компьютерном классе и библиотеке предусматривается возможность использования клавиатуры Брайля.
		</p>
	</div>
