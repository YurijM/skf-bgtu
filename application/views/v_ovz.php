<div class="objects row" itemprop="mtoOvz">
	...
	<h4 class="text-center">
		Информация о наличии средств обучения и воспитания для инвалидов и лиц с ограниченными возможностями здоровья
	</h4>
	...
	<p>
		Как для всех студентов филиала, так и для инвалидов и лиц с ограниченными возможностями здоровья,
		ежегодно проводятся культурно-воспитательные мероприятия, такие как: лектории; конкурсы; спортивные
		состязания; встречи с интересными людьми, ветеранами и участниками боевых действий, представителями
		профильных служб: миграционной службы, полиции, УФСКН, медицины, духовенства и др. Студенты выезжают на
		экскурсии.
	</p>
	...
	<div class="table-responsive" itemprop="ovz">
		<table class="table table-bordered table-condensed bg-info">
			<tr>
